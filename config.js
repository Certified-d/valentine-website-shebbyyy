...
const CONFIG = {
    ...
    // You can use emojis! 💝 💖 💗 💓 💞 💕
    pageTitle: "GRA NAKAKAHIYA UMAMIN!!",
    ...
    loveMessages: {
        extreme: "HARHRAHRAHARHARHARH SHESH 🥰🚀💝",  // Shows when they go past 5000%
        high: "NAKS NAMAN HEH 🚀💝",              // Shows when they go past 1000%
        normal: "HEHHSEHHSE <3"                           // Shows when they go past 100%
    },

    // Messages that appear after they say "Yes!"
    celebration: {
        title: "Hope ya liked my gift sheb!! Idk how to code yung response shit so kung ano man sagot mo, pls dms nalang natin so ik HUHUHUHU. (If you have no answer, that's fine toooo!!)",
